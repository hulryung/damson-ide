...
do {
    ...
    default:
        ...
        if method == "repo" || method == "browser" || method == "automations" || method == "worktree" || method == "host", case let .array(values)? = params.removeValue(forKey: "_args"), let subcommand = values.first?.stringValue {
